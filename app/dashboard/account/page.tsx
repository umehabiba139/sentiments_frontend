            ...
            <TabsContent value="deactivate">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Temporarily deactivate or permanently delete your account</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  {deactivateSuccess && (
                    <Alert className="bg-green-50 text-green-800 border-green-200">
                      <CheckCircle2 className="h-4 w-4 text-green-600" />
                      <AlertTitle>Success!</AlertTitle>
                      <AlertDescription>Your account has been deactivated. Redirecting...</AlertDescription>
                    </Alert>
                  )}
                  ...
                  <Alert className="bg-amber-50 text-amber-800 border-amber-200">
                    ...
                    <AlertDescription>
                      Deactivating your account will temporarily disable your access. Deleting your account is permanent
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <h3 className="text-lg font-medium">Temporary Deactivation</h3>
                      <p className="text-sm text-muted-foreground">
                        Your account will be disabled and hidden from other users until you log in again.
                      </p>
                      ...
                      <Dialog open={deactivateDialogOpen} onOpenChange={setDeactivateDialogOpen}>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            ...
                            <DialogDescription>
                              Are you sure you want to deactivate your account? You can reactivate it by logging in
                              again.
                            </DialogDescription>
                          </DialogHeader>
                          <DialogFooter>
                    ...
                    <div className="space-y-2">
                      <h3 className="text-lg font-medium">Permanent Deletion</h3>
                      <p className="text-sm text-muted-foreground">
                      ...
                      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            ...
                            <DialogDescription>
                              This action cannot be undone. All your data will be permanently deleted. Are you
